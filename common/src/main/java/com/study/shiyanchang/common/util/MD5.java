...
public class MD5 {
    ...
    //加的盐
    private static final String SALT = "ruWVG0wI3FQkeyBLZpQ3pWj48AV63dshangw";
    ...
    /**
     * @Description 微信MD5加密算法
     * @Author qinsihang
     * @Date 2017/10/11 17:19
     * @Param source
     * @Return java.lang.String
     */
    public static String wechatMD5(String source) {
        String des = "";
        try {
    ...
    public static void main(String args[]) {
    	System.out.println(MD5.EncoderByMd5("632ea55f-ccdb-4470-a7f1-2617ecb4ba0f"));
        System.out.println(MD5.encodeByMd5AndSalt("xxxxxxxxx-ccdb-4470-a7f1-2617ecb4ba0f"));
        System.out.println(MD5.encodeByMd5AndSaltWithJs("18601228411"));
        System.out.println(MD5.encodeByMd5AndSaltWithJs("A3F33C425A3AA5877C5D6BB6448481FF"));
    }
}